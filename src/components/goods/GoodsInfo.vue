...
<script>
    import image1 from '../../images/goods1.jpg'
    import image2 from '../../images/goods2.jpg'
    import image3 from '../../images/goods3.jpg'
    // 导入轮播图组件
    ...
    export default {
        data() {
            return {
                ...
                lunbotu: [
                    {url: image1, img: image1},
                    {url: image2, img: image2},
                    {url: image3, img: image3},
                ], // 轮播图的数据
                goodsinfo: {
                    id: 1,
                    title: '苹果Apple iPhone 6 Plus 16G 4G手机',
                    add_time: "2017-04-19",
                    zhaiyao: "iPhone 6 Plus设计",
                    click: 0,
                    img_url: image1,
                    sell_price: 6049.00,
                    market_price: 7000,
